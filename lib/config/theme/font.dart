...
String get _sFOpenSansFamily => 'OpenSans';
String get _sFCairoFamily => 'Cairo';
...
extension FamilyUtils on TextStyle {
  TextStyle get cairoBold =>
      copyWith(fontWeight: _semiBold, fontFamily: _sFOpenSansFamily);
  TextStyle get sbd =>
...
abstract class _FontSize {
  static double get huge => _hugeFontSize.h;

  static const double _hugeFontSize = 24;

  static double get heading_01 => _heading_01FontSize.h;

  static const double _heading_01FontSize = 26.23;

  static double get heading_02 => _heading_02FontSize.h;

  static const double _heading_02FontSize = 20;

  static double get heading_03 => _heading_03FontSize.h;

  static const double _heading_03FontSize = 18;

  static double get heading_04 => _heading_04FontSize.h;

  static const double _heading_04FontSize = 40;

  static double get heading_05 => _heading_05FontSize.h;

  static const double _heading_05FontSize = 14;

  static double get heading_06 => _heading_06FontSize.h;

  static const double _heading_06FontSize = 22;

  static double get subtitle_01 => _subtitle_01FontSize.h;

  static const double _subtitle_01FontSize = 14;

  static double get subtitle_02 => _subtitle_02FontSize.h;

  static const double _subtitle_02FontSize = 12;

  static double get button => _buttonFontSize.h;

  static const double _buttonFontSize = 18;

  static double get body_01 => _body_01FontSize.h;

  static const double _body_01FontSize = 16;

  static double get body_02 => _body_02FontSize.h;

  static const double _body_02FontSize = 14;

  static double get caption => _captionFontSize.h;

  static const double _captionFontSize = 12;

  static double get overline => _overlineFontSize.h;
