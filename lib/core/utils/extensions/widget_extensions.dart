...
extension WidgetExtension on Widget {
  ...
  Widget directionalPadding(EdgeInsetsDirectional padding) =>
  ...
  Widget paddingAll(double value) =>
      Padding(padding: EdgeInsets.all(value.h), child: this);
  ...
  Widget pagePadding() => Padding(
      padding: HWEdgeInsetsDirectional.only(
          start: 12.5, top: 12.5, bottom: 12.5, end: 12.5),
      child: this);
